...
PLATFORM_LIST = [#screen zero
                ...
                (SCREEN_4+(BLOCK_SIZE*9), FLOOR, ((SCREEN_5+(BLOCK_SIZE*7))-(SCREEN_4+(BLOCK_SIZE*7))), FLOOR, COLOR1),
                 #screen one
                ...
                (SCREEN_1+(BLOCK_SIZE*12), FLOOR-BLOCK_SIZE*2, RECTANGLE_SIZE_X, RECTANGLE_SIZE_Y1, COLOR1),
                #screen two
                (SCREEN_2+(BLOCK_SIZE*7), FLOOR-RECTANGLE_SIZE_Y2, RECTANGLE_SIZE_X, RECTANGLE_SIZE_Y2, COLOR2),
                (SCREEN_2+(BLOCK_SIZE*15), FLOOR-RECTANGLE_SIZE_Y3, RECTANGLE_SIZE_X, RECTANGLE_SIZE_Y3, COLOR2),
                #screen three
                (SCREEN_3+(BLOCK_SIZE*10), FLOOR-RECTANGLE_SIZE_Y3, RECTANGLE_SIZE_X, RECTANGLE_SIZE_Y3, COLOR2),
#screen four
